...
class Agent:
    def __init__(self, alpha=0.0003, beta=0.0003, input_dims=[8],
        ...
        self.actor = ActorNetwork(n_actions=n_actions, name='actor',
                                  max_action=env.action_space.high, fc1_dims=layer1_size, fc2_dims=layer2_size)
        self.critic_1 = CriticNetwork(
            n_actions=n_actions, fc1_dims=layer1_size, fc2_dims=layer2_size, name='critic_1')
        self.critic_2 = CriticNetwork(
            n_actions=n_actions, fc1_dims=layer1_size, fc2_dims=layer2_size, name='critic_2')
